...
{% highlight javascript %}YAHOO.util.Event.addListener('body','mouseover',function(){
...
{% highlight javascript %}function makeArray() {
//临时数组
var arr = [];
//遍历提交的每一个参数
...
{% highlight javascript %}var arr = new Array();
